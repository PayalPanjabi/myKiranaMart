...
public class Constant {
    //MODIFICATION PART
    public static final String MAINBASEUrl = "https://mykiranamart.in/app-admin/"; //Admin panel url

    //If you have eCart Website then place here website URL otherwise admin panel url
    public static final String WebsiteUrl = "https://mykiranamart.in/";

    //set your jwt secret key here...key must same in PHP and Android
    public static final String JWT_KEY = "fdgrfhygjhghtrhgdfgfrdfgvtytry";
