...
public class Favorite extends Product implements Serializable {
    ...
    String id, name, slug, product_id, subcategory_id, image, description, status, date_added, category_id, indicator, manufacturer, made_in, return_status, cancelable_status, till_status,ratings,number_of_ratings;
